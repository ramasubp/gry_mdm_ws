(:: pragma bea:global-element-parameter parameter="$mASTERDATA_CUSTOMER1" element="ns1:MASTERDATA_CUSTOMER" location="../xsd/GryEbizCustomer.xsd" ::)
...
xf:BulkUpdateMasterData($mASTERDATA_CUSTOMER1)
