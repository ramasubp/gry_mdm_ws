...
<con:xqueryEntry xmlns:con="http://www.bea.com/wli/sb/resources/config">
    <con:xquery><![CDATA[(:: pragma bea:global-element-parameter parameter="$PutLocation" element="ns0:PutLocation" location="../../wsdl/TPTCustomer.wsdl" ::)
...
xf:TPTSitesUpdateXRefs($PutLocation,
    $PutLocationResponse)]]></con:xquery>
