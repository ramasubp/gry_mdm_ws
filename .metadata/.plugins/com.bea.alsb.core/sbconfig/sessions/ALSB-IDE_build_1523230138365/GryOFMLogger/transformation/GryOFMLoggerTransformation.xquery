...
xf:GryOFMLoggerTransformation($gryOFMLogger1)]]></con:xquery>
    <con:dependency location="../xsd/GryOFMLogger.xsd">
        <con:schema ref="GryOFMLogger/xsd/GryOFMLogger"/>
    </con:dependency>
    <con:dependency location="../xsd/Insert_Into_OFM_Log_sp.xsd">
        <con:schema ref="GryOFMLogger/xsd/Insert_Into_OFM_Log_sp"/>
    </con:dependency>
</con:xqueryEntry>